...
/* 
Question 20.Determine the busiest hours of the day across all branches by calculating the average number of invoices issued per hour. 
Display the top 5 busiest hours along with the corresponding branch and city.
*/
